		...
		<div class="row">
			...
			<div class="span10">
				...
				<div class="secondary-masthead">
					...
					<ul class="breadcrumb">
						<li><a href="Manager/goodsmgr.action">分类管理</a> <span
					...
					<div class="span10">
						...
						<div class="slate">
							...
							<form class="form-horizontal"
								action="Manager/updatetype.action?tid=${param.tid }"
								method="post">
								<fieldset>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											value="${param.ptid }"	name="ptid" id="ptid">
										</div>
									</div>
									<div class="control-group">
